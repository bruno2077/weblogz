...
export default function Avatar(props) {
    ...
    const options = []
    options.push(<li key="perfil" className="dropdown-item p-0 m-0" type="button"><Link to='/perfil' className="dropdown-option py-1 px-3"><i className="fas fa-address-card pe-3"></i>Perfil</Link></li>)
    
    if(props.admin)
        options.push(<li key="admin" className="dropdown-item p-0 m-0" type="button"><Link to='/admin' className="dropdown-option py-1 px-3"><i className="fas fa-cog pe-3"></i>Administração</Link></li>)
